...

{
  ...
  public class ScriptableStats : ScriptableObject
  {
    ...
    //[Tooltip("The player's color. This enum also exists for objects. The player can only interact with objects that match its color or have no color/are neutral")]
    //public playerColor activeColor = playerColor.neutral;

    //public Color color = new Color(0.8018868f, 0.3442061f, 0.3442061f);
